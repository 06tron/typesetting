changequote(«, »)define(NL, «
»)dnl
% define(SECTION, «& & \\NL\textbf{$1} & & $2 \\NL\hline[2pt]»)dnl
% define(SUBSECTION, «\SetCell[c=2]{l} \textbf{$1} & & ifelse($#, 2, $2, $2 --- $3) \\NL\hline[dotted]»)dnl
% changecom(%)dnl
...
\begin{tblr}{X[l]X[c]X[r]}
    ...
    \texttt{mrichardson@umass.edu} & Arlington MA, 02474 & \urllink{https://www.linkedin.com/in/3mrichardson/}{\texttt{linkedin.com/in/3mrichardson}} \\
	...
	SECTION(PROJECTS)
	SUBSECTION(Sudoku Website, \urllink{https://06tron.github.io/}{\texttt{06tron.github.io}})
    \SetCell[r=2,c=2]{l}
